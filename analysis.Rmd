...
# Corrplot
```{r}
model_vars <- df %>% select(log_salary, MP, PTS, FG_pct, FTA, TRB, AST, stocks, Value_Billions)
...
$$\widehat{log\_salary} = 0.10079 + 0.08228PTS + 0.03258MP + 0.23531stocks + 0.08700Age_{22-26} + 0.39501Age_{27-31} + 0.43997Age_{32-34}$$
