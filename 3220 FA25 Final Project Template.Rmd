...
\begin{itemize}
  \item Salary is right-skewed with a large upper tail of superstar contracts.
  \item Scoring shows a strong positive relationship with salary.
  \item Defensive stocks have a moderate positive association with salary.
  \item Award recognition corresponds with substantial salary increases.
  \item Salary peaks in mid-career age groups, aligning with performance arcs.
\end{itemize}
